...
function ProjectDetails({params}: {params : {id: string}}) {
  ...
  return (
    ...
    <div className="container mx-auto py-8  bg-gradient-to-b from-blue-950 to-white">
            ...
            <div className="flex flex-wrap mb-4">
              ...
              <div className="flex">
                {project.tags.map((tag, index) => (
                  <span key={index} className="inline-block bg-blue-500 rounded-full px-3 py-1 text-sm font-semibold text-white mr-2 mb-2">{tag}</span>
                ))}
              </div>
            </div>
          </div>
